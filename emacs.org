...
Use theme-looper to change themes.

#+begin_src emacs-lisp :tangle yes
  (use-package theme-looper
:bind ("s-0" . theme-looper-select-theme)
  :config
(theme-looper-set-favorite-themes '(hc-zenburn gruvbox-dark-soft gruvbox-light-soft sanityinc-tomorrow-night sanityinc-tomorrow-eighties poet poet-dark-monochrome poet-dark poet-monochrome))
)
#+end_src
...
Use TeX input method for text, markdown, and org files.
...
#+begin_src emacs-lisp :tangle yes
    ...
    (major-mode-hydra-bind latex-mode "Clean"
...
#+begin_src emacs-lisp :tangle yes
(global-set-key (kbd "s-1") 'swiper-isearch)
#+end_src
